...
./add_user.sh $agent $container $username $user_key
./applications/gui/gui_user.sh $agent $container $username
./applications/ece1373_2019/ece1373_a2_user.sh $agent $container $username
